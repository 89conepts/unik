                                            ...
                                            <ul class="flex flex-column gap14">
                                                <li class="product-item">
                                                    ...
                                                    <div class="flex items-center justify-between flex-grow">
                                                        <div class="name">
                                                            <a href="#" class="body-title-2">Patimax Fragrance Long...</a>
                                                ...
                                                <li class="product-item">
                                                    ...
                                                    <div class="flex items-center justify-between flex-grow">
                                                        <div class="name">
                                                            <a href="#" class="body-title-2">Nulo MedalSeries Adult Cat...</a>
                                                            <div class="text-tiny mt-3">100 Items</div>
                                                        </div>
                                                ...
                                                <li class="product-item">
                                                    ...
                                                    <div class="flex items-center justify-between flex-grow">
                                                        <div class="name">
                                                            <a href="#" class="body-title-2">Pedigree Puppy Dry Dog...</a>
                                                            <div class="text-tiny mt-3">100 Items</div>
                                                        </div>
                                                ...
                                                <li class="product-item">
                                                    ...
                                                    <div class="flex items-center justify-between flex-grow">
                                                        <div class="name">
                                                            <a href="#" class="body-title-2">Biscoito Premier Cookie...</a>
                                                            <div class="text-tiny mt-3">100 Items</div>
                                                        </div>
                                                ...
                                                <li class="product-item">
                                                    ...
                                                    <div class="flex items-center justify-between flex-grow">
                                                        <div class="name">
                                                            <a href="#" class="body-title-2 mb-3">Pedigree Adult Dry Dog...</a>
